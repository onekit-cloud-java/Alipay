...
public abstract class AlipayPayAPI extends AlipayAPI {
    ...
    public AlipayPayAPI(String app_id, String method, String format, String charset, String sign_type, String sign, String timestamp, String version, String app_auth_token) {
