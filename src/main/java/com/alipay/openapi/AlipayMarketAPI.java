...
public abstract class AlipayMarketAPI extends AlipayAPI {
    ...
    public AlipayMarketAPI(String app_id, String method, String format, String charset, String sign_type, String sign, String timestamp, String version, String app_auth_token) {
